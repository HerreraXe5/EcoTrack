  ...
  const handleGuardar = async () => {
    ...
    try {
      const response = await fetch(
        `${API_URL}/usuarios/${usuario?.id}?token=${token}`,
        {
          method: 'PUT',
  ...
  const handleEliminarCuenta = () => {
    Alert.alert('Eliminar Cuenta', '¿Estás seguro? Esta acción es IRREVERSIBLE.', [
      { text: 'Cancelar', style: 'cancel' },
      {
        ...
        onPress: () => {
          Alert.alert('Confirmación Final', '¿Continuar con la eliminación definitiva?', [
            { text: 'Cancelar', style: 'cancel' },
            {
    ...
    <SafeAreaView style={styles.fondo}>
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }}>
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.inputWrapper}>
              ...
              <View style={styles.inputContainer}>
                ...
                <TextInput style={styles.input} value={email} onChangeText={setEmail} keyboardType="email-address" autoCapitalize="none" editable={!cargando} />
              </View>
            </View>
            <View style={styles.inputWrapper}>
              ...
              <View style={styles.inputContainer}>
                ...
                <TextInput style={styles.input} value={telefono} onChangeText={setTelefono} keyboardType="phone-pad" editable={!cargando} />
              </View>
            </View>
          </View>
          ...
          <TouchableOpacity style={styles.botonEliminar} onPress={handleEliminarCuenta} disabled={cargando}>
...
const styles = StyleSheet.create({
  ...
  botonGuardar: {
    backgroundColor: '#064E3B', borderRadius: 12, height: 52,
  ...
  botonEliminar: {
    backgroundColor: '#FEE2E2', borderRadius: 12, height: 52,
